...
for (let i = 0; i < resultsLength; i++) {
    ...
    document.getElementById(`addfavorites${i}`).addEventListener("click", async () => {
...
// let buttonfav = document.getElementsByClassName("favoritos").id
...
/*
generarLibros(titles[i]).then(result => consol
    e.log(result))
